  ...
  <footer className="bg-gradient-to-r from-[#0f1535] via-[#1e2746] to-[#2e3a5e] text-cyan-100 py-10 px-4 mt-16">
    <div className="max-w-3xl mx-auto flex flex-col items-center gap-6">
      ...
      <div className="flex gap-6 mt-2">
        <a href="https://github.com/Vartikamaurya" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-cyan-500 hover:bg-cyan-400 text-white text-xl transition shadow-lg" aria-label="GitHub"><FaGithub /></a>
        <a href="https://www.linkedin.com/in/vartika-maurya-641380317" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-700 hover:bg-blue-500 text-white text-xl transition shadow-lg" aria-label="LinkedIn"><FaLinkedin /></a>
      ...
      <div className="flex flex-wrap justify-center gap-4 text-cyan-200 text-base items-center">
        <span className="flex items-center gap-1">📧 <a href="mailto:vartikamaurya350@gmail.com" className="hover:text-cyan-300 transition">vartikamaurya350@gmail.com</a></span>
        <span className="flex items-center gap-1">📍 India</span>
        <span className="flex items-center gap-1">💼 Open to Opportunities</span>
      </div>
      {/* Copyright */}
      <div className="text-cyan-300 text-sm mt-2">&copy; {new Date().getFullYear()} Vartika Maurya. All rights reserved.</div>
    </div>
  </footer>
);

...
const socialLinks = [
  {
    icon: <FaGithub />,
    url: 'https://github.com/Vartikamaurya',
    label: 'GitHub',
  },
  {
    icon: <FaLinkedin />,
    url: 'www.linkedin.com/in/vartika-maurya-641380317',
    label: 'LinkedIn',
  },
  {
    icon: <FaEnvelope />,
    url: 'vartikamaurya350@gmail.com',
    label: 'Email',
  },
];
...
const testimonials = [
  {
    ...
    feedback: 'Working with Vartika was a game-changer. He delivered our project ahead of schedule and exceeded expectations in both design and performance!'
  },
  {
    name: 'Priya Verma',
  ...
  },
  {
    ...
    feedback: 'Professional, reliable, and creative. Vartika handled complex integrations and AI features with ease. Will hire again!'
  },
  {
    name: 'Sara Khan',
      ...
      <section className="relative flex flex-col-reverse md:flex-row items-center justify-between min-h-[80vh] max-w-7xl mx-auto px-4 py-12 md:py-24 gap-8">
        ...
        <div ref={heroTextRef} className="flex-1 z-10 text-left space-y-6">
          ...
          <div className="flex gap-6 mt-8">
            <a
              href="https://github.com/Vartikamaurya"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/vartika-maurya-641380317"
              target="_blank"
              rel="noopener noreferrer"
              className="text-3xl hover:text-cyan-400 transition-colors"
              aria-label="LinkedIn"
